...
class Camera:
    ...
    def update_camera_vectors(self):
        ...
        self.right = self.forward.cross(Vec3(0, 1, 0)).normalize()
    ...
    def get_view_matrix(self):
        # https://github.com/pyglet/pyglet/issues/708
        #return Mat4.look_at(position=self.position, target=self.position + self.forward, up=self.up)
        #return self.look_at(position=Vec3(0, 0, 5), target=Vec3(0, 0, 0), up=self.up)
